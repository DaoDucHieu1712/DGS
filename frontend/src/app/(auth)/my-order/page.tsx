...
const MyOrderPage = () => {
  ...
  const ordersQuery = useQuery({
    ...
    queryFn: async (context) => {
      return OrderServices.getMyOrder(context);
    },
  });
  ...
  return (
    <div className="container mx-auto">
      <div className="flex justify-between p-2">
        <div className="">
          <h1 className="text-2xl text-orange-400 font-bold mb-3">my order</h1>
          <span className="text-sm">See infomation about all my orders</span>
        </div>
      </div>
      <div className="mt-5">
